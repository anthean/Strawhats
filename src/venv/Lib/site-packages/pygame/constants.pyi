...
WINDOWEVENT_ENTER: int
WINDOWEVENT_EXPOSED: int
WINDOWEVENT_FOCUS_GAINED: int
WINDOWEVENT_FOCUS_LOST: int
WINDOWEVENT_HIDDEN: int
WINDOWEVENT_HIT_TEST: int
WINDOWEVENT_LEAVE: int
WINDOWEVENT_MAXIMISED: int
WINDOWEVENT_MINIMIZED: int
WINDOWEVENT_MOVED: int
WINDOWEVENT_RESIZED: int
WINDOWEVENT_RESTORED: int
WINDOWEVENT_SHOWN: int
WINDOWEVENT_SIZE_CHANGED: int
WINDOWEVENT_TAKE_FOCUS: int
